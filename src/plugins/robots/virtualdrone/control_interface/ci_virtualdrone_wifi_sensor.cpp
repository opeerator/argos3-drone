/**
 * @file <argos3/plugins/robots/virtualdrone/control_interface/ci_virtualdrone_wifi_sensor.cpp>
 *
 * @author Michael Allwright <allsey87@gmail.com>
 */

#include "ci_virtualdrone_wifi_sensor.h"
...
#ifdef ARGOS_WITH_LUA
   void CCI_VirtualDroneWifiSensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_VirtualDroneWifiSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
